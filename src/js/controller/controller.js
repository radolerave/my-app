export default class Fs {
    ...
    async getSellerInfos(apiUrl, sellerId) {
        const columns = `activities,contacts,country,keywords,localities,name,sectors,space,credit_tokens,who_what,hourly,calendar,nif,stat,rcs,cin,about,trade_name,photo_id,date_add,last_edit`
